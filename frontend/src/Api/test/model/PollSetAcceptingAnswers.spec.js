...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PollSetAcceptingAnswers', function() {
      beforeEach(function() {
        instance = new PollPalApi.PollSetAcceptingAnswers();
      });

      it('should create an instance of PollSetAcceptingAnswers', function() {
        // TODO: update the code to test PollSetAcceptingAnswers
        expect(instance).to.be.a(PollPalApi.PollSetAcceptingAnswers);
      });
