...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PollSubmitResponseRequest', function() {
      beforeEach(function() {
        instance = new PollPalApi.PollSubmitResponseRequest();
      });

      it('should create an instance of PollSubmitResponseRequest', function() {
        // TODO: update the code to test PollSubmitResponseRequest
        expect(instance).to.be.a(PollPalApi.PollSubmitResponseRequest);
      });
