...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SessionStartRequest', function() {
      beforeEach(function() {
        instance = new PollPalApi.SessionStartRequest();
      });

      it('should create an instance of SessionStartRequest', function() {
        // TODO: update the code to test SessionStartRequest
        expect(instance).to.be.a(PollPalApi.SessionStartRequest);
      });
