...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PollNextQuestionRequest', function() {
      beforeEach(function() {
        instance = new PollPalApi.PollNextQuestionRequest();
      });

      it('should create an instance of PollNextQuestionRequest', function() {
        // TODO: update the code to test PollNextQuestionRequest
        expect(instance).to.be.a(PollPalApi.PollNextQuestionRequest);
      });
